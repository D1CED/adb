...
This package is not intended to be used directly. adb.Server and adb.Device
use it to abstract away the bit-twiddling details of the protocol. You should only ever
need to work with the go-adb package. Also, this package's API may change more frequently
than go-adb's.
